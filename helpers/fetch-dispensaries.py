...
def main():
    ...
    for r in priF[:lim]:
        ...
        out.append({
            ...
            "business_website": str(r.get("business_website") or "").strip(),
            "hours_of_operation": str(r.get("hours_of_operation") or "").strip(),
            "primary_contact_name": str(r.get("primary_contact_name") or "").strip(),
            "issued_date": str(r.get("issued_date") or "").strip(),
            "expiration_date": str(r.get("expiration_date") or "").strip(),
            "retail_date_opened_to_public": str(r.get("retail_date_opened_to_public") or "").strip(),
